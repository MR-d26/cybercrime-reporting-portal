...
export const Page10TrackComplaint: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FAF9F6] relative overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 md:py-10 flex-1 flex flex-col justify-between relative z-10">
