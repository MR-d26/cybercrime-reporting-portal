...
export const Page05AddDetails: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FAF9F6] relative overflow-hidden">
      {/* 1. Subtle, scaled background watermark for Page 05 */}
      <div
        className="absolute inset-0 bg-contain bg-top bg-no-repeat pointer-events-none opacity-30"
        style={{ backgroundImage: "url('/images/indian-cybercrime-background.png')" }}
        aria-hidden="true"
      />
      {/* Soft warm overlay ensuring text contrast */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#FAF9F6]/80 via-[#FAF9F6]/95 to-[#FAF9F6] pointer-events-none" aria-hidden="true" />

      {/* 2. Progress Stepper Bar (Step 4 Active) */}
      <ProgressStepper activeStep={4} />

      {/* 3. Main Content Container */}
      <main className="max-w-3xl mx-auto w-full px-4 sm:px-6 py-4 md:py-6 flex-1 flex flex-col justify-between relative z-10">
        
        <div className="space-y-5">
          {/* Header Title & Subtitle */}
          <div className="text-left space-y-1">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-gov-navy leading-tight">
              {t.detailsTitle}
            </h2>
            <p className="text-xs sm:text-sm font-semibold text-[#E65100]">
              {t.detailsSubtitle}
            </p>
          </div>

          {/* MAIN FORM CARD CONTAINER */}
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 md:p-7 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-2.5 sm:p-3 rounded-xl border outline-none text-sm transition-all ${
                      dontKnowDate
            ...
            <div className="space-y-3 pb-5 border-b border-gray-100">
              ...
              <div className="max-w-md pt-1">
                ...
                <input
                  ...
                  className={`w-full p-2.5 sm:p-3 rounded-xl border outline-none text-sm font-bold transition-all ${
                    dontKnowAmount
                      ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed'
                ...
                <div className="space-y-3 pb-5 border-b border-gray-100">
                  ...
                  <div className="max-w-md pt-1">
                    <input
                      ...
                      className={`w-full p-2.5 sm:p-3 rounded-xl border outline-none text-sm font-semibold transition-all ${
                        dontHaveTxnId
                          ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed'
                          : 'border-gray-300 focus:border-gov-navy focus:ring-2 focus:ring-gov-navy/20'
                      }`}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 sm:p-3 rounded-xl border border-gray-300 outline-none text-sm focus:border-gov-navy font-medium"
                  />
                </div>
        ...
        <div className="mt-6 flex items-center justify-between pt-4 border-t border-gray-200/80">
          <button
            onClick={handleBack}
          ...
          <button
            ...
            className="flex items-center gap-2.5 bg-[#0F2540] hover:bg-[#1A365D] text-white font-bold px-8 py-3 rounded-xl shadow-md hover:shadow-lg transition-all active:scale-98 focus:ring-4 focus:ring-amber-300 outline-none cursor-pointer"
          >
